...
<template>
  <div class="toolbar">
    ...
    <div class="toolbar-center">
      <button class="tb-btn" title="字体设置" @click="appState.showFontSettings = true">Aa</button>
      <button class="tb-btn" title="背景设置" @click="appState.showBgSettings = true">
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round">
    <path d="M7 3L10 3L10 6L12 4L14 6L14 3L17 3L20 7L18 9L18 20L6 20L6 9L4 7Z"/>
      ...
      <div class="divider"></div>
      <button class="tb-btn" title="一键排版" @click="formatCurrentDoc">排</button>
